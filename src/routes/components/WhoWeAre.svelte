...
<section class="mt-20 container mx-auto">
    <h2 class="customShadow mb-[3rem] text-center text-[2.5rem] font-bold text-[#04095d] capitalize">Who we are</h2>
    <!-- TODO:replace the image with a youtube video -->
    <div class="w-[600px] h-auto relative mx-auto border-l-8 border-r-8 border-[#04095d] rounded-lg">
