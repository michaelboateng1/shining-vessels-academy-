...
<section bind:this={sectionElement} class="container mx-auto px-5 sm:w-[80%] py-10">
    {#if visible}
        <p 
            ...
            class="welcome-text text-md font-semibold after:content-[' '] relative after:block after:absolute after:bottom-1/2 after:translate-y-1/2 after:right-0 after:h-[1px] after:bg-[#ccc] after:w-[65%] sm:after:w-[95%] text-[#04095d]"
        >
            Welcome to
        </p>
        <div>
            <div class="flex justify-start items-start gap-5 mt-2 sm:mt-5">
                ...
                <div>
                    <p 
                        ...
                        class="w-[50ch] hidden sm:block py-3 text-md text-[#333]"
                    >
                    ...
                    <div 
                        ...
                        class="flex gap-5 hidden sm:block mt-3"
                    >
